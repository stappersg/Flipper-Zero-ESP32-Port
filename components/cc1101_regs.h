...
static inline CC1101Status cc1101_status_from_raw(uint8_t raw) {
    return (CC1101Status){.raw = raw};
}

static inline uint8_t cc1101_status_fifo_bytes_available(CC1101Status status) {
    return status.raw & 0x0F;
}

static inline CC1101State cc1101_status_state(CC1101Status status) {
    return (CC1101State)((status.raw >> 4) & 0x07);
}

static inline bool cc1101_status_is_ready(CC1101Status status) {
    return (status.raw & 0x80) == 0;
}
...
static inline uint8_t cc1101_tx_bytes_available(CC1101TxBytes status) {
    return status.raw & 0x7F;
}

static inline bool cc1101_tx_bytes_underflow(CC1101TxBytes status) {
    return (status.raw & 0x80) != 0;
}
...
static inline uint8_t cc1101_rx_bytes_available(CC1101RxBytes status) {
    return status.raw & 0x7F;
}

static inline bool cc1101_rx_bytes_overflow(CC1101RxBytes status) {
    return (status.raw & 0x80) != 0;
}
