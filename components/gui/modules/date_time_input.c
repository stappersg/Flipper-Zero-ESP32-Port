...
// #include "furi_hal_rtc.h" // ESP32: not available
#include <furi.h>
#include <assets_icons.h>

// ESP32: provide fallback for missing furi_hal_rtc locale definitions
#ifndef FuriHalRtcLocaleTimeFormat24h
typedef enum {
    FuriHalRtcLocaleTimeFormat24h,
    FuriHalRtcLocaleTimeFormat12h,
} FuriHalRtcLocaleTimeFormat;

static inline FuriHalRtcLocaleTimeFormat furi_hal_rtc_get_locale_timeformat(void) {
    return FuriHalRtcLocaleTimeFormat24h; // Default to 24h format on ESP32
}
#endif
