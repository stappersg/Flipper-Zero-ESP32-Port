...
/**
 * Override malloc to zero-initialize memory.
 * Flipper firmware assumes malloc returns zeroed memory (STM32 heap starts zeroed).
 * On ESP32, malloc does not zero memory, so we redirect to calloc.
 */
