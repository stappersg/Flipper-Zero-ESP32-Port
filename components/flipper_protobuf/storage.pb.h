...
typedef enum _PB_Storage_File_FileType {
    PB_Storage_File_FileType_FILE = 0, /* default value */
...
typedef struct _PB_Storage_TarExtractRequest {
    char *tar_path;
    char *out_path;
} PB_Storage_TarExtractRequest;
...
#define PB_Storage_File_type_ENUMTYPE PB_Storage_File_FileType
...
#define PB_Storage_ListRequest_init_default      {NULL, 0, 0}
...
#define PB_Storage_TarExtractRequest_init_default {NULL, NULL}
...
#define PB_Storage_ListRequest_init_zero         {NULL, 0, 0}
...
#define PB_Storage_TarExtractRequest_init_zero   {NULL, NULL}
...
#define PB_Storage_File_md5sum_tag               5
...
#define PB_Storage_ListRequest_include_md5_tag   2
#define PB_Storage_ListRequest_filter_max_size_tag 3
...
#define PB_Storage_TarExtractRequest_tar_path_tag 1
#define PB_Storage_TarExtractRequest_out_path_tag 2
...
X(a, STATIC,   SINGULAR, STRING,   md5sum,            5)
...
X(a, POINTER,  SINGULAR, STRING,   path,              1) \
X(a, STATIC,   SINGULAR, BOOL,     include_md5,       2) \
X(a, STATIC,   SINGULAR, UINT32,   filter_max_size,   3)
...
#define PB_Storage_TarExtractRequest_FIELDLIST(X, a) \
X(a, POINTER,  SINGULAR, STRING,   tar_path,          1) \
X(a, POINTER,  SINGULAR, STRING,   out_path,          2)
#define PB_Storage_TarExtractRequest_CALLBACK NULL
#define PB_Storage_TarExtractRequest_DEFAULT NULL
...
extern const pb_msgdesc_t PB_Storage_TarExtractRequest_msg;
...
#define PB_Storage_TarExtractRequest_fields &PB_Storage_TarExtractRequest_msg
...
/* PB_Storage_TarExtractRequest_size depends on runtime parameters */
#define PB_STORAGE_STORAGE_PB_H_MAX_SIZE         PB_Storage_Md5sumResponse_size
