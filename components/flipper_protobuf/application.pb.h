...
typedef struct _PB_App_AppButtonPressReleaseRequest {
    char args[513];
    int32_t index;
} PB_App_AppButtonPressReleaseRequest;
...
#define PB_App_AppButtonPressReleaseRequest_init_default {"", 0}
...
#define PB_App_AppButtonPressReleaseRequest_init_zero {"", 0}
...
#define PB_App_AppButtonPressReleaseRequest_args_tag 1
#define PB_App_AppButtonPressReleaseRequest_index_tag 2
...
#define PB_App_AppButtonPressReleaseRequest_FIELDLIST(X, a) \
X(a, STATIC,   SINGULAR, STRING,   args,              1) \
X(a, STATIC,   SINGULAR, INT32,    index,             2)
#define PB_App_AppButtonPressReleaseRequest_CALLBACK NULL
#define PB_App_AppButtonPressReleaseRequest_DEFAULT NULL
...
extern const pb_msgdesc_t PB_App_AppButtonPressReleaseRequest_msg;
...
#define PB_App_AppButtonPressReleaseRequest_fields &PB_App_AppButtonPressReleaseRequest_msg
...
#define PB_App_AppButtonPressReleaseRequest_size 526
