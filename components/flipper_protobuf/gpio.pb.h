...
typedef enum _PB_Gpio_GpioOtgMode {
    PB_Gpio_GpioOtgMode_OFF = 0,
    PB_Gpio_GpioOtgMode_ON = 1
} PB_Gpio_GpioOtgMode;
...
typedef struct _PB_Gpio_GetOtgMode {
    char dummy_field;
} PB_Gpio_GetOtgMode;

typedef struct _PB_Gpio_GetOtgModeResponse {
    PB_Gpio_GpioOtgMode mode;
} PB_Gpio_GetOtgModeResponse;

typedef struct _PB_Gpio_SetOtgMode {
    PB_Gpio_GpioOtgMode mode;
} PB_Gpio_SetOtgMode;
...
#define _PB_Gpio_GpioOtgMode_MIN PB_Gpio_GpioOtgMode_OFF
#define _PB_Gpio_GpioOtgMode_MAX PB_Gpio_GpioOtgMode_ON
#define _PB_Gpio_GpioOtgMode_ARRAYSIZE ((PB_Gpio_GpioOtgMode)(PB_Gpio_GpioOtgMode_ON+1))

#define PB_Gpio_SetPinMode_pin_ENUMTYPE PB_Gpio_GpioPin
#define PB_Gpio_SetPinMode_mode_ENUMTYPE PB_Gpio_GpioPinMode

#define PB_Gpio_SetInputPull_pin_ENUMTYPE PB_Gpio_GpioPin
#define PB_Gpio_SetInputPull_pull_mode_ENUMTYPE PB_Gpio_GpioInputPull

#define PB_Gpio_GetPinMode_pin_ENUMTYPE PB_Gpio_GpioPin

#define PB_Gpio_GetPinModeResponse_mode_ENUMTYPE PB_Gpio_GpioPinMode

#define PB_Gpio_ReadPin_pin_ENUMTYPE PB_Gpio_GpioPin


#define PB_Gpio_WritePin_pin_ENUMTYPE PB_Gpio_GpioPin


#define PB_Gpio_GetOtgModeResponse_mode_ENUMTYPE PB_Gpio_GpioOtgMode

#define PB_Gpio_SetOtgMode_mode_ENUMTYPE PB_Gpio_GpioOtgMode
...
#define PB_Gpio_GetOtgMode_init_default          {0}
#define PB_Gpio_GetOtgModeResponse_init_default  {_PB_Gpio_GpioOtgMode_MIN}
#define PB_Gpio_SetOtgMode_init_default          {_PB_Gpio_GpioOtgMode_MIN}
...
#define PB_Gpio_GetOtgMode_init_zero             {0}
#define PB_Gpio_GetOtgModeResponse_init_zero     {_PB_Gpio_GpioOtgMode_MIN}
#define PB_Gpio_SetOtgMode_init_zero             {_PB_Gpio_GpioOtgMode_MIN}
...
#define PB_Gpio_GetOtgModeResponse_mode_tag      1
#define PB_Gpio_SetOtgMode_mode_tag              1
...
#define PB_Gpio_GetOtgMode_FIELDLIST(X, a) \

#define PB_Gpio_GetOtgMode_CALLBACK NULL
#define PB_Gpio_GetOtgMode_DEFAULT NULL

#define PB_Gpio_GetOtgModeResponse_FIELDLIST(X, a) \
X(a, STATIC,   SINGULAR, UENUM,    mode,              1)
#define PB_Gpio_GetOtgModeResponse_CALLBACK NULL
#define PB_Gpio_GetOtgModeResponse_DEFAULT NULL

#define PB_Gpio_SetOtgMode_FIELDLIST(X, a) \
X(a, STATIC,   SINGULAR, UENUM,    mode,              1)
#define PB_Gpio_SetOtgMode_CALLBACK NULL
#define PB_Gpio_SetOtgMode_DEFAULT NULL
...
extern const pb_msgdesc_t PB_Gpio_GetOtgMode_msg;
extern const pb_msgdesc_t PB_Gpio_GetOtgModeResponse_msg;
extern const pb_msgdesc_t PB_Gpio_SetOtgMode_msg;
...
#define PB_Gpio_GetOtgMode_fields &PB_Gpio_GetOtgMode_msg
#define PB_Gpio_GetOtgModeResponse_fields &PB_Gpio_GetOtgModeResponse_msg
#define PB_Gpio_SetOtgMode_fields &PB_Gpio_SetOtgMode_msg

/* Maximum encoded size of messages (where known) */
#define PB_GPIO_GPIO_PB_H_MAX_SIZE               PB_Gpio_WritePin_size
#define PB_Gpio_GetOtgModeResponse_size          2
#define PB_Gpio_GetOtgMode_size                  0
...
#define PB_Gpio_SetOtgMode_size                  2
