...
typedef enum _PB_Gui_InputType {
    PB_Gui_InputType_PRESS = 0, /* *< Press event, emitted after de-bounce */
    PB_Gui_InputType_RELEASE = 1, /* *< Release event, emitted after de-bounce */
    ...
    PB_Gui_InputType_REPEAT = 4 /* *< Repeat event, emitted with INPUT_REPEATE_PRESS period after InputTypeLong event */
} PB_Gui_InputType;
...
typedef enum _PB_Gui_ScreenOrientation {
    ...
    PB_Gui_ScreenOrientation_VERTICAL_FLIP = 3 /* *< Vertical flipped (270) */
...
typedef struct _PB_Gui_StartVirtualDisplayRequest {
    ...
    PB_Gui_ScreenFrame first_frame; /* *< Optional: screen frame to show */
    bool send_input; /* *< Optional: send flipper input */
...
#define PB_Gui_ScreenFrame_orientation_ENUMTYPE PB_Gui_ScreenOrientation



#define PB_Gui_SendInputEventRequest_key_ENUMTYPE PB_Gui_InputKey
#define PB_Gui_SendInputEventRequest_type_ENUMTYPE PB_Gui_InputType
...
#define PB_Gui_StartVirtualDisplayRequest_init_zero {false, PB_Gui_ScreenFrame_init_zero, 0}
...
#define PB_Gui_StartVirtualDisplayRequest_send_input_tag 2
...
X(a, STATIC,   SINGULAR, BOOL,     send_input,        2)
...
#define PB_GUI_GUI_PB_H_MAX_SIZE                 PB_Gui_SendInputEventRequest_size
