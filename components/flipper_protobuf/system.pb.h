...
typedef enum _PB_System_RebootRequest_RebootMode {
    PB_System_RebootRequest_RebootMode_OS = 0, /* default value */
...
#define PB_System_RebootRequest_mode_ENUMTYPE PB_System_RebootRequest_RebootMode
...
#define PB_System_UpdateResponse_code_ENUMTYPE PB_System_UpdateResponse_UpdateResultCode
...
#define PB_SYSTEM_SYSTEM_PB_H_MAX_SIZE           PB_System_GetDateTimeResponse_size
