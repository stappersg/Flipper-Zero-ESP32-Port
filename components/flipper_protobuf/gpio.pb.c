...
PB_BIND(PB_Gpio_GetOtgMode, PB_Gpio_GetOtgMode, AUTO)


PB_BIND(PB_Gpio_GetOtgModeResponse, PB_Gpio_GetOtgModeResponse, AUTO)


PB_BIND(PB_Gpio_SetOtgMode, PB_Gpio_SetOtgMode, AUTO)
