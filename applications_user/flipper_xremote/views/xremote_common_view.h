...
typedef struct {
    ...
    bool right_pressed;
    bool hold;
    uint8_t selected; /* T-Embed rotary selection: 0=OK, 1=Up, 2=Down, 3=Left, 4=Right, 5=Back */
} XRemoteViewModel;
...
typedef enum {
    ...
    XRemoteViewSubmenu,
    XRemoteViewLearn,
    XRemoteViewLearnGeneral,
    XRemoteViewLearnTV,
    XRemoteViewLearnSoundSystem,
    XRemoteViewLearnFan,
    XRemoteViewLearnHeater,
    XRemoteViewLearnCustom,
    XRemoteViewSaved,
    XRemoteViewAnalyzer,
    XRemoteViewSettings,
    XRemoteViewAbout,
