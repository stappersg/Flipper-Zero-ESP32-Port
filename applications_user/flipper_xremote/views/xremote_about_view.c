...
static void xremote_about_view_draw_horizontal(Canvas* canvas, XRemoteViewModel* model) {
    ...
    elements_slightly_rounded_frame(canvas, 62, 20, 62, 39);
    canvas_draw_str_aligned(canvas, 64, 22, AlignLeft, AlignTop, "Contact:");
    canvas_draw_str_aligned(canvas, 68, 34, AlignLeft, AlignTop, "s.kalatoz");
    canvas_draw_str_aligned(canvas, 90, 44, AlignLeft, AlignTop, "@");
    canvas_draw_str_aligned(canvas, 70, 54, AlignLeft, AlignTop, "gmail.com");
}
